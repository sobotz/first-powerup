...
public class Lift {
	...
	public void liftControl() {
		...
		/*
		 * 
		 * // Going down if(Robotmap.liftEncoder.getDirection()) {
		 * 
		 * if(!Robotmap.bottomPosition.get()) { down_speed = 0.25; }
		 * 
		 * }else { if(!Robotmap.bottomPosition.get()) { down_speed = 0.6; } }
		 * 
		 * /// Going Up if(!Robotmap.liftEncoder.getDirection()) {
		 * 
		 * if(!Robotmap.topPosition.get()) { up_speed = -0.25; }
		 * 
		 * }else { if(!Robotmap.topPosition.get()) { up_speed = -0.6; } }
		 */
